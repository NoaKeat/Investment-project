  ...
  return (
    <section className={styles.statementSection}>
      ...
      <div className={styles.quoteIcon}>
        ...
        >
          <path
            d="M20.2178 0.500122H50.0449V49.4415C50.0328 60.9733 45.8123 72.0216 38.3203 80.1642C30.9479 88.1769 21.0026 92.7267 10.6094 92.881V82.8947C17.7211 82.7555 24.5706 79.9555 29.998 74.965C35.5515 69.8586 39.2597 62.7899 40.4756 55.0118L40.5654 54.4347H0.5V21.9738C0.500065 16.2658 2.58713 10.799 6.29004 6.77454C9.99163 2.75161 15.0025 0.500201 20.2178 0.500122Z"
            stroke="url(#paint0)"
          />
          <path
            d="M85.3428 0.500244H115.17V49.4417C115.158 60.9735 110.937 72.0217 103.445 80.1643C96.0729 88.177 86.1276 92.7269 75.7344 92.8811V82.8948C82.8461 82.7556 89.6956 79.9556 95.123 74.9651C100.677 69.8587 104.385 62.7901 105.601 55.012L105.69 54.4348H65.625V21.9739C65.6251 16.2659 67.7121 10.7992 71.415 6.77466C75.1166 2.75173 80.1275 0.500323 85.3428 0.500244Z"
            stroke="url(#paint1)"
          />
          <defs>
