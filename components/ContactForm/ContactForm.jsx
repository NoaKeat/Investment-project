...
export default function ContactForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setStatus("error");
            setMessage("שליחה נכשלה, נסי שוב");
        }
    };
        ...
        <section className={styles.section}>
            <div className={styles.container}>
                ...
                <p className={styles.subtitle}>
                    נשמח לשמוע כל שאלה או פניה, ונחזור אליכם בהקדם:)
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.row}>
                        ...
                        <div className={styles.field}>
                            <label>שם*</label>
                            <input name="name" placeholder="מה שמכם?" className={styles.input} />
                        </div>

                        <div className={styles.field}>
                            <label>טלפון*</label>
                            <input name="phone" placeholder="והטלפון?" className={styles.input} />
                        </div>

                        <div className={styles.field}>
                            <label>*מייל</label>
                            <input name="email" placeholder="והמייל?" className={styles.input} />
                        </div>

                    </div>

                    <div className={styles.fieldFull}>
                        <label>מה תרצו לומר?</label>
                        <textarea
                            name="message"
                            placeholder=""
